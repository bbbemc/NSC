(() => {
  ...
  /* ---------- 1. Type‑writer ---------- */
  const text =
    'ได้รับทุนอุดหนุนจากโครงการการแข่งขันพัฒนาโปรแกรมคอมพิวเตอร์แห่งประเทศไทย ครั้งที่ 27 จากสำนักงานพัฒนาวิทยาศาสตร์และเทคโนโลยีแห่งชาติ';
  let index = 0;
...
function setupLoginButton() {
  const loginBtn = document.querySelector('.button-Sign');
  if (!loginBtn) return;
...
document.getElementById('text-Already').addEventListener('click', () => {
  window.location.href = 'index.html';
});